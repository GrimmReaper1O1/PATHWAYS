...
// let openMenu = (paths, classPaths, obj) => {
//     let el = [];    
//     let el2 = [];
...
//         // console.log(paths)
//         el[i] = document.getElementsByClassName(paths[i]);

//         for (let a = 0; a < el[i].length; a++) {
    

//             // console.log(el);

//             el[i][a].classList.remove('hidden');
//         }

//     }
//     for (let i = 0; i < classPaths.length; i++) {
    
//         el2[i] = document.getElementById(classPaths[i]);
...
//     }
//     try {
//         insertFPath(fPath, obj);    
//     } catch { }
// }
//  const isItem = (path, obj) => {
//   //// console.log(path);    
...
// if (typeof current[path[path.length-1]].item !== 'undefined') {
//  if (current[path[path.length-1]].item === true) {return true;    
...
// let insertFPath = (fPath, menuObj) => {
//   let elFPathInput = document.querySelectorAll('.fPath');    
//   for (let i = 0; i < elFPathInput.length; i++) {
//   elFPathInput[i].name = JSON.stringify(fPath);    

//   }
//   if (fPath) {
//     try {
// let isItema = isItem(fPath, menuObj);    

// if (isItema) {
//     let result0 = document.getElementById('category');    

//     let result1 = document.getElementById('itemName');
//     let result2 = document.getElementById('price');
//     let result3 = document.getElementById('stn');
//     let result4 = document.getElementById('gst');
//     let result5 = document.getElementById('barcodeDisplay');
//     let infoObj = getByPath(fPath, JSON.parse(useMenuObj));
//     // console.log(infoObj);
//     result1.name = infoObj[1].name;
//     result2.name = infoObj[1].price;
//     result3.name = infoObj[1].stn;
//     result4.name = infoObj[1].gst;
//     result5.textContent = infoObj[1].barcode;
...
//   // const isItemAlwaysInStock = (path, obj) => {
//     //// console.log(path);    
...
//     // console.log(current);
//     // console.log(current[path[path.length-1]]);
//   if (typeof current[path[path.length-1]] !== 'undefined' && typeof current[path[path.length-1]].stn !== 'undefined') {
//     return [0,current[path[path.length-1]]];    
//   } else if (typeof current[path[path.length-1]] !== 'undefined' && typeof current[path[path.length-1]].name !== 'undefined')
//   {
//     return [1,current[path[path.length-1]]];
//   } else {
//     return false;    
//   }
//   };
    ...
    let createMenu2 = (ob, st = '', c = 0, uid = {}, numeralC = 0) => {
        ...
        for (let itemKey in obj) {
            ...
            if (typeof newObj.bS !== 'undefined') {
                ...
                string2 += `class="button ${newObj.cONC}">OPTION: ${newObj.itemKey+1} LEVEL: ${counter+1} ${newObj.bS}</button><br>`;
